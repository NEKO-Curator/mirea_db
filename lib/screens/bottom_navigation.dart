...
import 'package:mirea_db_2/screens/firestore_cards_page.dart';
import 'package:mirea_db_2/screens/local_cards_page.dart';
                ...
                await Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => _currentIndex == 0
                        ? const CardDetail()
                        : (_currentIndex == 1 ? Container() : Container()),
                  ),
                );
                setState(() {});
              },
